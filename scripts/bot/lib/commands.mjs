...
function outreachMessage() {
  ...
  const offer = pick([
    'Хочу предложить — могу за пару дней бесплатно сделать вам сайт, просто чтобы показать.',
    'Готов бесплатно собрать вам сайт за пару дней — для примера.',
    'Могу за пару дней бесплатно сделать вам пробный вариант сайта.',
    'Хочу бесплатно сделать вам сайт за пару дней и прислать посмотреть.',
    'Подумал, что вам может пригодиться — сделаю бесплатно пробный вариант за пару дней.',
  ]);
  const calm = pick([
    'Понравится — здорово, нет — ничего страшного.', 'Ни к чему не обязывает.',
    'Без обязательств, просто покажу.', 'Если зайдёт — продолжим, нет — без проблем.',
    'Посмотрите спокойно и сами решите.', 'Без оплаты, просто покажу результат.',
  ]);
