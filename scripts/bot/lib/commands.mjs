...
function outreachMessage(lead) {
  const templates = [
    `Здравствуйте! Делаю современные сайты, которые превращают посетителей в заявки. Готов за пару дней бесплатно собрать прототип под ваш бизнес — оцените. Понравится — оставите за символическую сумму, нет — без обид. Показать?`,
    `Добрый день! Соберу вам продающий сайт-визитку бесплатно как пример — современный, под заявки. Скинуть на оценку, без обязательств?`,
    `Привет! Делаю лендинги, которые реально приносят заявки. Готов за пару дней бесплатно сделать прототип, чтобы вы оценили. Интересно?`,
    `Здравствуйте! Подскажите, у вас есть нормальный сайт? Могу за пару дней бесплатно собрать прототип — посмотрите, решите. Без обязательств.`,
    `Добрый день! Делаю сайты для бизнеса под заявки. Предлагаю бесплатно собрать вам прототип — современный, продающий. Понравится — обсудим. Ок?`,
  ];
