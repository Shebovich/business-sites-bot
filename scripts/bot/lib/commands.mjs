...
function outreachMessage(lead) {
  const templates = [
    `Здравствуйте! Увидел вашу рекламу. Делаю современные сайты, которые превращают просмотры в заявки — за пару дней бесплатно соберу прототип под ваш бизнес, оцените. Понравится — оставите за символическую сумму, нет — без обид. Показать?`,
    `Добрый день! Заметил, что вы вкладываетесь в рекламу. Хороший сайт усилит её отдачу. Соберу вам продающий сайт-визитку бесплатно как пример. Скинуть на оценку?`,
    `Привет! Вижу вашу рекламу — делаю лендинги, которые реально приносят заявки. Готов за пару дней сделать прототип бесплатно, чтобы вы оценили. Интересно?`,
    `Здравствуйте! Подскажите, у вас есть нормальный сайт под рекламу? Могу бесплатно за пару дней собрать прототип — посмотрите, решите. Без обязательств.`,
    `Добрый день! Делаю сайты для бизнеса под заявки. Предлагаю бесплатно собрать вам прототип — современный, продающий. Посмотрите, понравится — обсудим. Ок?`,
  ];
